...
#pragma target 5.0
   ...
   #define OUTPUT_PATCH_SIZE 3
				...
				[maxvertexcount(90)]
				void geom(triangle d2f inp[3], inout LineStream<f_input> OutputStream)
				{
					f_input output = (f_input)0;
					output.vertex = inp[0].vertex;
					OutputStream.Append(output);
					output.vertex = inp[1].vertex;
					OutputStream.Append(output);
					output.vertex = inp[2].vertex;
					OutputStream.Append(output);
